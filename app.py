...
MIXED_KEEP_TIME_SAVE_VS_TRANSIT_ABS = 8       # 8분 이상 빠르면 유지 (기존 10)
MIXED_KEEP_TIME_SAVE_VS_TRANSIT_RATIO = 0.15  # 15% 이상 빠르면 유지 (기존 20%)
MIXED_MAX_EXTRA_COST_VS_TRANSIT = 35000        # 3.5만원까지 허용 (기존 2만원)
MIXED_HIGH_TAXI_SHARE = 0.75
MIXED_HIGH_TAXI_KM = 25.0                     # 25km까지 허용 (기존 20km)
